...
(function dmv_online_highscores(){"use strict";
    ...
    */ 
    const host = "http://imagindragons.com/dmv-osohigh/";
    ...
    */
    const highscore_lists = {
        ...
        // 
        "Test": { 
            head: 'Points High Score',
            posi: default_position,
            post: {
                sname: default_scorename,
                score: "(10**7)/($gameSystem.playtime()**0.7)*(1 + 0.25*(+($gameVariables.value(12) == 1)) + 0.5*(+($gameVariables.value(12) == 0)))",
                extra: "''",
            },
        },
        // 
